...
+ Article
    ...
    + [MySQLでIN句の中に大量の値の入ったクエリがフルスキャンを起こす話](https://developers.freee.co.jp/entry/large-in-clouse-length-cause-full-scan)
    + [pt-online-schema-changeによる負荷を好きなメトリクスでコントロールする](https://shallow1729.hatenablog.com/entry/modify-pt-osc-for-rds)
    + [MySQLのオンラインDDLでレプリケーション遅延を回避する方法](https://qiita.com/yy_harachi/items/b2463c0872e044c8c25a)
    + [自作DBを始めたい人におすすめの本](https://tarovel4842.hatenablog.com/entry/2021/12/20/084413)
    + [より深く知るオプティマイザとそのチューニング](https://www.slideshare.net/hayamiz/ss-42415350)
    + [An overview of query optimization in relational systems 論文紹介](https://www.slideshare.net/kumagi/an-overview-of-query-optimization-in-relational-systems)
    + [PostgreSQLのMVCCとガベージコレクション](https://masahikosawada.github.io/2021/12/22/MVCC-and-GC-in-PostgreSQL/)
    + [データ損失を回避しよう 各DBの機能比較](https://speakerdeck.com/tzkoba/detasun-shi-wohui-bi-siyou-ge-dbfalseji-neng-bi-jiao)
    ...
    + [CppCon2022/scalable_and_low_latency_lock-free_data_structures.pdf at main · CppCon/CppCon2022](https://github.com/CppCon/CppCon2022/blob/main/Presentations/scalable_and_low_latency_lock-free_data_structures.pdf)
    + [DMMの取り組み最前線 ~フルマネージドNewSQLであるTiDB Cloudの可能性~](https://speakerdeck.com/yuyu_hf/db-tech-showcase-2022-dmm-inspect-full-managed-newsql-tidb-cloud)
    + [Efficient MySQL Performance](https://www.oreilly.com/library/view/efficient-mysql-performance/9781098105082/)
    + [速習！論理レプリケーション ～基礎から最新動向まで～（PostgreSQL Conference Japan 2022 発表資料）](https://www.slideshare.net/nttdata-tech/postgresql-logical-replication-postgresql-conference-japan-2022-nttdata)
    ...
    + [Concurrent Hash Tables](https://notryan.com/pdf/concurrent_hashmaps.pdf)
    + [Latch-free Synchronization in Database Systems](http://www.jmfaleiro.com/pubs/latch-free-cidr2017.pdf)
    + [Split Ordered Hash Map](https://www.docswell.com/s/kumagi/5988JL-lock-free-hash-table)
    + [Lock-free入門](https://kumagi.com/lockfree.pdf)
    + [A Scalable Lock Manager for Multicores](https://trustworthy.systems/publications/nicta_full_text/6465.pdf)
    + [Is Parallel Programming Hard, And, If So, What Can You Do About It?](https://arxiv.org/pdf/1701.00854)
    + [Read-Copy Update: Using Execution History to Solve Concurrency Problems](https://citeseerx.ist.psu.edu/document?repid=rep1&type=pdf&doi=5be17f9e3aed27f28440f81e6030a3269e919d51)
    + [userspace RCU(QSBR)の使い方と解説](https://kumagi.hatenadiary.org/entry/20130803/1375492517)
