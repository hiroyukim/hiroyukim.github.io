...
+ Article
    ...
    + [絡み合うSaaSプロダクトのマイクロサービスアーキテクチャ](https://speakerdeck.com/mosa_siru/luo-mihe-usaashurotakutofalsemaikurosahisuakitekutiya-layerx)
    ...
    + [cosign実行時のやりとりを覗いてみた](https://otameshi61.hatenablog.com/entry/cosign-attest-internal)
    + [接続してきたSSL/TLSクライアントを判定するライブラリ](https://github.com/salesforce/ja3)
    + [SNATポート枯渇を見つけるメトリックの見方](https://tech-blog.cloud-config.jp/2022-09-13-viewing-metrics-to-prevent-snat-port-exhaustion/)
    ...
    + [GA4のBigQuery SQLを書くときに便利なライブラリ「BigQuery Utils」](https://www.principle-c.com/column/ga/ga4/ga4-library-bigquery-utils/)
    + [マイクロサービス／分散モノリス的アーキテクチャへの攻撃手法](https://gmo-cybersecurity.com/news/security_camp_presentation_slide_20220901/)
    + [Unicode をレンダリングするときは言語情報を渡しましょう](https://blog.8-p.info/ja/2022/09/30/unicode/)
    + [サーバダウンしたニコニコ漫画に何が起きていたのか](https://developers.bookwalker.jp/entry/2022/10/28/110000)
    + [実践 9 つのメモリリークどう見つける？](https://speakerdeck.com/orgachem/how-to-detect-9-types-of-memory-leaks)
    ...
    + [Kubernetesネイティブなワークフローエンジンとは！FAANSでArgo Workflowsを導入した話](https://techblog.zozo.com/entry/faans-argo-workflows)
    ...
    + [WasmerはどのようにWasmからネイティブバイナリを作っているのか？](https://qiita.com/0kate/items/a962f81b48add3314bda)
    + [Hyrumの法則とレガシ―コード置き換えの実践](https://blog.cybozu.io/entry/2022/12/16/080000)
    + [マイクロサービスとトランザクション](https://qiita.com/kazutomo/items/036d341d90bbcca91413)
    + [How Tailscale works](https://tailscale.com/blog/how-tailscale-works/)
    + [Moving past TCP in the data center, part 1](https://lwn.net/Articles/913260/)
    + [はてなスターのひみつ - Hatena Developer Blog](https://htn.to/35fQrxw2Gk)
    + [C#11 による世界最速バイナリシリアライザー「MemoryPack」の作り方](https://speakerdeck.com/neuecc/c-number-11-niyorushi-jie-zui-su-bainarisiriaraiza-memorypack-nozuo-rifang)
    + [どこのご家庭にもあるNASにPi-holeを導入して、ネットワーク側で広告を非表示にした話 - fetburner.core](https://fetburner.hatenablog.com/entry/2022/12/08/195946)
    + [【資料公開】マネージャーのしごと](https://htn.to/4v2PEpzstw)
    + [SSHGuard](http://htn.to/JvgdGg)
    + [GitHub - leandromoreira/cdn-up-and-running: CDN Up and Running - Building a CDN from Scratch to Learn](https://github.com/leandromoreira/cdn-up-and-running)
    + [コンテナイメージのlazy pullingをcurlで試してみる - knqyf263's blog](https://knqyf263.hatenablog.com/entry/2021/06/15/071057)
    + [サブドメイン名列挙の方法についてまとめてみた - NFLabs. エンジニアブログ](https://blog.nflabs.jp/entry/2022/12/19/093000)
    ...
    + [バックグラウンドタブ内のsetTimeout/setIntervalのスロットリング挙動 | Wantedly Engineer Blog](https://www.wantedly.com/companies/wantedly/post_articles/439961)
    + [Caching Unstructured Objects using controller-runtime - Blog of @ymmt2005](https://ymmt2005.hatenablog.com/entry/2021/07/25/Caching_Unstructured_Objects_using_controller-runtime)
    + [アプリケーションエンジニアが知るべきDNSの基本/Basics_of_DNS_that_application_engineers_should_know](https://speakerdeck.com/mamy1326/basics-of-dns-that-application-engineers-should-know?slide=173)
    + [タイムゾーン呪いの書 (知識編)](https://zenn.dev/dmikurube/articles/curse-of-timezones-common-ja)
    + [Fuzzing Farm #3: パッチ解析とPoC開発](https://ricercasecurity.blogspot.com/2022/10/fuzzing-farm-3-poc.html)
    + [WebAssembly上で動くLunaticランタイムを使ったHTTPサーバーを実装する](https://zenn.dev/helloyuki/articles/c9fb64eeaa1a30)
    + [GitHub - shiguredo/tls13-zig: The first TLS1.3 implementation in Zig(master/HEAD) only with std.](https://github.com/shiguredo/tls13-zig)
    + [PHPカンファレンス2022にてSPAセキュリティ超入門の話をします](https://blog.tokumaru.org/2022/09/super-introduction-to-spa.html)
    + [Cloudflare で mTLS を利用する](https://zenn.dev/shiguredo/articles/cloudflare-mtls)
    + [準同型暗号の脆弱性とは？ - プライバシーテック研究所](https://acompany.tech/privacytechlab/vulnerability-homomorphic-encryption/)
    + [Microservices Pattern: A pattern language for microservices](https://microservices.io/patterns/)
    + [セキュリティ・バイ・デザイン導入指南書 ：IPA 独立行政法人 情報処理推進機構](https://www.ipa.go.jp/icscoe/program/core_human_resource/final_project/security-by-design.html)
